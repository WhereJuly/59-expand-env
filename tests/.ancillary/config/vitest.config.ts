...
export default defineConfig({
    ...
    resolve: {
        alias: {
            ...
            '@fixtures': fileURLToPath(new URL(`${root}/tests/.ancillary/fixtures`, import.meta.url)),
        }
    },
    test: {
        /**
        ...
        // setupFiles: ['./tests/.ancillary/bootstrap/setup.ts'],
        cache: false,
        reporters: ['verbose'],
        globals: true,
        // INFO: Can be configured via TEST_INCLUDE environment variable
        exclude: excluded,
